...
window.CATEGORIES = [
  ...
  { key: 'digital', icon: '💻', img: 'wreath',      circleBg: 'navy',   label: 'דיגיטל וטכנולוגיה',    tags: ['פיתוח ואוטומציות', 'בניית אתרים', 'חבילות תקשורת וסלולר', 'מחשוב ומעבדות תיקון', 'חנות טלפונים', 'שיווק ומיתוג', 'קמפיינים וקידום אתרים'] },
